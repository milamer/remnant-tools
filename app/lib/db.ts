...
const itemToLinkedItems: Record<string, string[]> = {
  ...
  // Losomn
  'Crescent Moon': ["Anamy's Echo"],
  Deceit: ["Imposter's Heart"],
  Nightfall: ['Cursed Dream Silks'],
  Monarch: ['Agony Spike'],
  'Rune Pistol': ['Decrepit Rune'],
  Anguish: ['Occult Vessel'],
  'Huntress Spear': ['Venerated Spearhead'],
  Godsplitter: ['Melded Hilt'],
  Nightshade: ["Nightweaver's Finger"],
  Wrathbringer: ["Tormentor's Pommel"],
  ...
  // Yaesha
  Merciless: ['Crimson Membrane'],
  'Twisted Arbalest': ['Twisted Lazurite'],
  Monolith: ['Eye of Lydusa'],
  Thorn: ['Regurgitated Spiny Sac'],
  'Feral Judgement': ["Ravager's Maw"],
  'Red Doe Staff': ["Doe's Antler"],
  Stonebreaker: ['Hollow Heart'],
  Mirage: ['Blossoming Core'],
...
export function getLocation(worldName: string, locationName: string) {
  ...
  if (locationName === 'World Drops')
    return {
      baseItems: world?.worldDrops ?? [],
      isWorldDropPresent: true,
      events: [],
    };
